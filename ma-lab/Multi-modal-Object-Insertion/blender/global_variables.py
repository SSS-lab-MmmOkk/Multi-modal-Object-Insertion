...
g_blender_executable_path = config.camera_config.blender_path
g_matlab_executable_path = 'E:\\MATLAB\R2017a\\bin\\matlab'
...
g_syn_images_lmdb_pathname_prefix = '/ShapeNetDL/projects/render4cnn/syn_lmdb'
